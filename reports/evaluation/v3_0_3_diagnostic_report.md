...
- generated_at: 2026-06-01T22:18:52
...
| hybrid_best | 0 |
| tied_best | 24 |
| hybrid_worse_than_bm25 | 4 |
| hybrid_worse_than_dense | 1 |
| top5_hit_but_no_top1 | 1 |
| all_failed | 0 |
| section_metadata_missing | 17 |
...
| case_id | category | intent_type | dense_rank | bm25_rank | hybrid_rank | best_mode | dense_top1_page | bm25_top1_page | hybrid_top1_page | dense_top1_section | bm25_top1_section | hybrid_top1_section | comparison_note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| front_hood_close_warning_001 | warning_notice | safety_notice | 2 | 1 | 2 | bm25 | 308 | 308 | 308 | N/A | N/A | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| front_hood_open_001 | procedure | specific_operation | 3 | 1 | 3 | bm25 | 308 | 307 | 308 | N/A | 驾驶员座椅下方的保险丝盒 | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| seatbelt_fastening_001 | procedure | specific_operation | 1 | 4 | 2 | dense | 101 | 99 | 99 | 系紧安全带 | 安全带未系提醒 | 安全带作用 | all_hit_within_top5,hybrid_worse_than_dense,dense_best |
| tire_repair_after_limits_001 | parameter_query | limit_parameter | 3 | 1 | 2 | bm25 | 341 | 342 | 341 | N/A | N/A | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| tire_repair_before_001 | warning_notice | safety_notice | 2 | 1 | 2 | bm25 | 341 | 341 | 341 | N/A | N/A | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |

## Top-5 Hit but Not Top-1 Cases

| case_id | category | intent_type | dense_rank | bm25_rank | hybrid_rank | best_mode | worst_mode | dense_top1_page | bm25_top1_page | hybrid_top1_page | comparison_note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| epb_enable_release_001 | procedure | specific_operation | 2 | 3 | 2 | dense,hybrid | bm25 | 159 | 159 | 159 | all_hit_within_top5,top5_hit_but_no_top1 |

## Section Metadata Missing Cases

| case_id | category | intent_type | dense_top1_page | bm25_top1_page | hybrid_top1_page | dense_top1_section | bm25_top1_section | hybrid_top1_section | comparison_note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| front_hood_close_warning_001 | warning_notice | safety_notice | 308 | 308 | 308 | N/A | N/A | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| front_hood_open_001 | procedure | specific_operation | 308 | 307 | 308 | N/A | 驾驶员座椅下方的保险丝盒 | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| tire_repair_after_limits_001 | parameter_query | limit_parameter | 341 | 342 | 341 | N/A | N/A | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| tire_repair_before_001 | warning_notice | safety_notice | 341 | 341 | 341 | N/A | N/A | N/A | all_hit_within_top5,hybrid_worse_than_bm25,bm25_best,section_metadata_missing |
| airbag_explanation_001 | explanation | concept_explanation | 102 | 103 | 103 | 安全气囊 | 安全气囊注意事项 | N/A | all_top1_hit,section_metadata_missing |
| charging_gun_handling_001 | procedure | specific_operation | 289 | 289 | 289 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
| charging_safety_001 | warning_notice | safety_notice | 295 | 295 | 295 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
| child_lock_enable_001 | procedure | state_explanation | 122 | 122 | 122 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
| defrost_enable_location_001 | procedure | location_and_operation | 256 | 257 | 256 | 空调除霜/除雾 | N/A | 空调除霜/除雾 | all_top1_hit,section_metadata_missing |
| fuel_safety_001 | warning_notice | safety_notice | 162 | 163 | 162 | N/A | N/A | N/A | all_hit_within_top5,section_metadata_missing |
| fuel_steps_001 | procedure | specific_operation | 163 | 163 | 163 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
| high_voltage_label_001 | warning_notice | forbidden_condition | 287 | 304 | 304 | 高压警告标签 | N/A | N/A | all_top1_hit,section_metadata_missing |
| low_voltage_battery_maintenance_001 | maintenance_check | maintenance_guidance | 304 | 304 | 304 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
| onboard_charging_steps_001 | procedure | specific_operation | 289 | 298 | 289 | 车载充电设备充电 | N/A | 车载充电设备充电 | all_top1_hit,section_metadata_missing |
| seatbelt_usage_001 | usage_guidance | broad_usage_guidance | 99 | 103 | 99 | 安全带作用 | N/A | 安全带作用 | all_hit_within_top5,section_metadata_missing |
| tire_repair_kit_location_001 | location_query | location_query | 340 | 340 | 340 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
| wiper_caution_001 | maintenance_check | safety_notice | 63 | 63 | 63 | N/A | N/A | N/A | all_top1_hit,section_metadata_missing |
