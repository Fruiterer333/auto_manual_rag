# V3.5 Recalibrated Rerank Evaluation Comparison

> Metrics were recomputed after V3.5 retrieval benchmark recalibration; differences from legacy reports may reflect corrected evaluation labels rather than production retrieval changes.

- generated_at: 2026-09-01T22:15:58
- baseline: `reports/evaluation/v3_5_recalibrated_hybrid_no_rerank.json`
- experiment: `reports/evaluation/v3_5_recalibrated_hybrid_rerank.json`
...
| wiper_caution_001 | warning_notice | safety_notice | 2 | 2 | 后雨刮和洗涤器 | 后雨刮和洗涤器 |
...
| warning_notice | 16 | 0.5000 | 0.6875 | 0.1875 | 0.7104 | 0.8177 | 0.1073 |
...
| safety_notice | 12 | 0.4167 | 0.6667 | 0.2500 | 0.6694 | 0.8194 | 0.1500 |
...
| --- | ---: | ---: | ---: | ---: |
| elapsed_seconds | 31.2052 | 37.4957 | +6.2906 | 1.20x |
| average_seconds_per_case | 0.4589 | 0.5514 | +0.0925 | 1.20x |
