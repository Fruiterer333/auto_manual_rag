...
- generated_at: 2026-09-03T13:11:06
...
- git_commit: e86728dcaa803f5de8add2d620be3bfdcd6f6fe4
- git_worktree_dirty: True
- answer_prompt_sha256: 87849928b0d76794a9474205c4aa6a7d32272e775b733c8de24e452eb4743f58
...
| average_elapsed_seconds | 9.3864 |
...
电子驻车制动（EPB）的启用和释放方法如下： 1. **启用电子驻车制动（EPB）**： - 您可以使用电子驻车制动器开关手动启用紧急制动功能。在车辆行驶过程中如出现紧急情况，可以拉住电子驻车制动器开关，启用紧急制动功能。释放电子驻车制动器开关后，即可解除紧急制动。 2. **释放电子驻车制动（EPB）**： - **方法一**：启动车辆后，将变速器挂入D或R挡，踩下油门踏板也可以释放电子驻车制动。 - **方法二**：踩下制动踏板并启动车辆，沿箭头方向按下EPB开关，释放EPB功能，红色EPB指示灯会自动熄灭。 请注意，在EPB处于释放状态时，应注意车辆周边环境，防止溜车危险。
...
8. 使用高压清洗机或蒸汽清洗机时，喷嘴与车身表面的距离至少应保持30厘米，且需保持喷嘴移动，避免高压水流浸入车辆零部件内造成损坏。
9. 请务必严格按高压清洗器使用说明清洁车辆，特别注意工作压力和喷洗距离。
10. 清洗完车辆后，若要立即驾车，请数次踩下制动踏板，以去除制动摩擦片上的水汽，确保制动效率。
11. 请勿使喷嘴直接或间接对发动机舱内进行冲洗，以免造成发动机舱内的电气元件受损或部件不能正常使用。

请务必遵循以上注意事项，以确保车辆清洁和安全。
...
9. 请务必严格按高压清洗器使用说明清洁车辆，特别注意工作压力和喷洗距离。
10. 清洗完车辆后，若要立即驾车，请数次踩下制动踏板，以去除制动摩擦片上的水汽，确保制动效率。
11. 请勿使喷嘴直接或间接对发动机舱内进行冲洗，以免造成发动机舱内的电气元件受损或部件不能正常使用。 请务必遵循以上注意事项，以确保车辆清洁和安全。
...
2. 如果警告灯点亮，请按照 Evidence E5 中的步骤进行检查：
   ...
   - 如果没有发现功能下降或受限的情况，请根据 Evidence E5 中列出的故障类型采取相应措施，如轮胎漏气或车辆电池电量过低（页码340、343）。
   - 如果上述步骤都无法解决问题，请联系Lynk & Co领克中心寻求帮助。

3. 根据 Evidence E4 的说明，在制动过程中，您可能会感觉到机舱内有连续“咯咯”的声音以及制动踏板的振动。这是防抱死制动系统正常工作时的现象，而非故障。

请务必重视防抱死制动系统的警告，并按照上述步骤操作以确保行车安全。

**Final answer:**

当制动防抱死系统发生故障时，您需要注意以下几点： 1. 和 的说明，防抱死制动系统存在故障时，警告灯会点亮。请留意仪表盘上的警告灯。 2. 如果警告灯点亮，请按照 的步骤进行检查： - 检查仪表显示屏和中央显示屏是否有警告/指示消息。如果有，请了解这些图标的含义和相应的处理措施，可以参考指示灯和警告灯的相关内容（页码69）。 - 如果没有警告消息，检查是否有任何系统功能下降或受限。如果有，请采取适当措施解决故障，例如打开前机舱盖、检查安全带等（页码307、99）。 - 如果没有发现功能下降或受限的情况，请列出的故障类型采取相应措施，如轮胎漏气或车辆电池电量过低（页码340、343）。 - 如果上述步骤都无法解决问题，请联系Lynk & Co领克中心寻求帮助。 3. 的说明，在制动过程中，您可能会感觉到机舱内有连续“咯咯”的声音以及制动踏板的振动。这是防抱死制动系统正常工作时的现象，而非故障。 请务必重视防抱死制动系统的警告，并按照上述步骤操作以确保行车安全。
...
制动防抱死系统的主要作用是在您施加最大制动力时，防止车轮抱死。这在大多数路况下，特别是在紧急制动时，可以改善车辆的转向控制性能。当系统正常工作时，在制动过程中您可能会感觉到机舱内有连续的“咯咯”声以及制动踏板的振动，这是正常现象。如果防抱死制动系统停止工作，制动踏板的感觉会恢复到非防抱死制动的状态。
...
请注意，如果车辆已锁且挡位处于驻车挡（P）的情况下，还需要确保没有上述任何问题才能通过手机APP远程启动发动机。
...
- 发动机出现故障（例如出现发动机关键故障代码）。
- 车辆设置为维修模式。
- 连续两次远程启动车辆后，未手动启动车辆。 请注意，如果车辆已锁且挡位处于驻车挡（P）的情况下，还需要确保没有上述任何问题才能通过手机APP远程启动发动机。
...
此时，EPB将自动启用，以确保车辆在熄火后保持静止状态。请确保在操作过程中注意车辆周边环境，以防止溜车危险。
...
2. 将挡位切换至驻车挡（P）。
3. 激活EPB电子驻车系统。
4. 短按START/STOP按钮，使车辆熄火。 此时，EPB将自动启用，以确保车辆在熄火后保持静止状态。请确保在操作过程中注意车辆周边环境，以防止溜车危险。
...
2. 车辆熄火状态下，不踩制动踏板，长按START/STOP按钮7秒，待车辆完成自检后，踩住制动踏板，将变速器切换至N挡，再按下EPB开关，将EPB切换至释放状态，长按START/STOP按钮使车辆下电。 请注意，在EPB处于释放状态时，应注意车辆周边环境，防止溜车危险。
...
请注意，如果充电接口插座指示灯红色报警，请拔出充电枪并锁止车辆，等待车辆休眠后再进行充电操作。若再次尝试红色指示灯仍然持续点亮，请联系Lynk & Co领克中心寻求帮助。

**Final answer:**

充电接口LED指示灯的不同颜色分别表示以下充电状态： - 蓝色常亮（2分钟后熄灭）：表示预约充电。
- 蓝色闪烁：表示对外放电。
- 绿色闪烁：表示充电中。
- 绿色常亮：表示充电完成。
- 绿-绿-红依次闪烁：表示充电中电子锁故障。
- 红色常亮：表示充电故障。
- 橙色常亮：表示充电预加热中。
- 橙-橙-红依次闪烁：表示充电预加热中电子锁故障。 请注意，如果充电接口插座指示灯红色报警，请拔出充电枪并锁止车辆，等待车辆休眠后再进行充电操作。若再次尝试红色指示灯仍然持续点亮，请联系Lynk & Co领克中心寻求帮助。
...
我没有在手册中找到可靠依据说明如何通过语音命令校准制动系统。根据提供的信息，手册中主要描述了如何使用中央显示屏语音助手进行车辆功能控制、设置语音助手的相关选项以及制动系统的正常工作状态说明。没有关于通过语音命令校准制动系统的具体说明。
