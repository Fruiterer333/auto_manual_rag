...
- generated_at: 2026-09-03T15:04:39
...
- ollama_model_tag: gemma3:12b
- ollama_model_digest: f4031aab637d1ffa37b42570452ae0e4fad0314754d17ded67322e4b95836f8a
...
*   您可以使用电子驻车制动（EPB），使车辆保持静止状态。（E4）

**释放：**

*   踩下制动踏板并启动车辆，沿箭头方向按下EPB开关，释放EPB功能，红色EPB指示灯自动熄灭。（E2）
*   启动车辆后，将变速器挂入D或R挡，踩下油门踏板也可以释放电子驻车制动。（E1）

**紧急制动：**

*   车辆行驶过程中如出现紧急情况，您可以拉住电子驻车制动器开关，启用紧急制动功能。释放电子驻车制动器开关后，即可解除紧急制动。（E3）

**熄火时解除EPB的注意事项：**

*   在EPB处于释放状态时，应注意车辆周边环境，防止溜车危险。（E5）

**Final answer:**

电子驻车制动（EPB）的使用方法如下： **启用：** * 您可以使用电子驻车制动（EPB），使车辆保持静止状态。（E4） **释放：** * 踩下制动踏板并启动车辆，沿箭头方向按下EPB开关，释放EPB功能，红色EPB指示灯自动熄灭。（E2）
* 启动车辆后，将变速器挂入D或R挡，踩下油门踏板也可以释放电子驻车制动。（E1） **紧急制动：** * 车辆行驶过程中如出现紧急情况，您可以拉住电子驻车制动器开关，启用紧急制动功能。释放电子驻车制动器开关后，即可解除紧急制动。（E3） **熄火时解除EPB的注意事项：** * 在EPB处于释放状态时，应注意车辆周边环境，防止溜车危险。（E5）
...
如果仪表显示屏上提示“未检测到钥匙”，说明遥控钥匙电池电量低，请将遥控钥匙放入前杯托底部，再按照上述步骤启动车辆。

**Final answer:**

要使用遥控钥匙启动车辆，请按照以下步骤操作： 1. 确保遥控钥匙已正确编码。
2. 将挡位置于驻车挡（P）。
3. 将遥控钥匙放置于车内。
4. 将制动踏板踩到底。
5. 长按START/STOP按钮，车辆启动后松开按钮。 如果仪表显示屏上提示“未检测到钥匙”，说明遥控钥匙电池电量低，请将遥控钥匙放入前杯托底部，再按照上述步骤启动车辆。
...
*   **安全第一：** 清洗车辆后，若要立即驾车，请数次踩下制动踏板，以去除制动摩擦片上的水汽，避免影响制动效率。
*   **检查：** 清洗前，检查并确认车辆的外部开闭件已正确关闭。
*   **避免损坏：**
    *   禁止将水枪对准车辆底部接插件进行冲洗。
    *   避免用高压清洗机或蒸汽清洗机对传感器进行清洁，清洗时应保持至少10厘米以上的距离，并使用较小的水流短时间冲洗。
    *   务必严格按高压清洗器使用说明操作，喷嘴与车身表面至少保持30厘米的距离，并保持喷嘴移动，避免长时间对某个部位喷水。
    *   请勿使喷嘴直接或间接对发动机舱内进行冲洗，以免损坏电气元件或导致部件不能正常使用。
*   **工作压力和距离：** 严格按照高压清洗器使用说明清洁车辆，特别注意工作压力和喷洗距离。

**Final answer:**

使用高压水枪清洗车辆时，请注意以下事项： * **安全第一：** 清洗车辆后，若要立即驾车，请数次踩下制动踏板，以去除制动摩擦片上的水汽，避免影响制动效率。
* **检查：** 清洗前，检查并确认车辆的外部开闭件已正确关闭。
* **避免损坏：** * 禁止将水枪对准车辆底部接插件进行冲洗。 * 避免用高压清洗机或蒸汽清洗机对传感器进行清洁，清洗时应保持至少10厘米以上的距离，并使用较小的水流短时间冲洗。 * 务必严格按高压清洗器使用说明操作，喷嘴与车身表面至少保持30厘米的距离，并保持喷嘴移动，避免长时间对某个部位喷水。 * 请勿使喷嘴直接或间接对发动机舱内进行冲洗，以免损坏电气元件或导致部件不能正常使用。
* **工作压力和距离：** 严格按照高压清洗器使用说明清洁车辆，特别注意工作压力和喷洗距离。
...
当制动防抱死系统发生故障时，警告灯会点亮。如果仪表显示屏或中央显示屏有警告/指示消息，请了解这些图标的含义和相应的处理措施，详情请参见指示灯和警告灯章节。如果无故障提示，但系统功能下降或受限，请采取适当措施解决故障，例如打开前机舱盖、检查安全带等。如果问题仍然存在，请联系领克中心寻求帮助。
...
车辆配备制动防抱死系统，可在您施加最大制动力时，防止车轮抱死。在大多数路况下，它能改善紧急制动情况下车辆的转向控制性能。

需要注意的是，制动过程中可能会感觉到机舱传来连续“咯咯”的声音，并感受到制动踏板传来的振动，这是防抱死制动系统工作时的正常现象。当防抱死制动系统停止工作时，制动踏板的感觉会恢复到非防抱死制动的状态。

**Final answer:**

车辆配备制动防抱死系统，可在您施加最大制动力时，防止车轮抱死。在大多数路况下，它能改善紧急制动情况下车辆的转向控制性能。 需要注意的是，制动过程中可能会感觉到机舱传来连续“咯咯”的声音，并感受到制动踏板传来的振动，这是防抱死制动系统工作时的正常现象。当防抱死制动系统停止工作时，制动踏板的感觉会恢复到非防抱死制动的状态。
...
自动驻车（Auto Hold）可以在正常驾驶过程中的短暂停车时提供制动，这样您就不需要一直踩制动踏板。车辆需要起步时，踩下加速踏板或用力踩下制动踏板再松开，车辆即可正常行驶。
...
车辆配备超速报警功能，当车速高于超速报警车速设定值时，系统会发出声音警告，仪表显示屏上会弹出提示信息提醒您减速。车速低于超速报警车速设定值时，报警会解除。

您可以在中央显示屏中点击“Lynk Co-Pilot”-“超速报警”进入设置界面，进行开启/关闭和调节超速报警车速设定值。

**请注意：** 超速报警功能无法防止您超过设定的超速报警车速，驾驶员必须注意控制车速，安全行驶。

**Final answer:**

车辆配备超速报警功能，当车速高于超速报警车速设定值时，系统会发出声音警告，仪表显示屏上会弹出提示信息提醒您减速。车速低于超速报警车速设定值时，报警会解除。 您可以在中央显示屏中点击“Lynk Co-Pilot”-“超速报警”进入设置界面，进行开启/关闭和调节超速报警车速设定值。 **请注意：** 超速报警功能无法防止您超过设定的超速报警车速，驾驶员必须注意控制车速，安全行驶。
...
- matched_must_include_terms: 车速设定值; 声音警告
- missing_must_include_terms: 减慢车速; 报警解除
- forbidden_term_hits: N/A
- evidence_structure_hit: True
- expected_section_hit: True
- expected_subsection_hit: N/A
...
以下情况下无法通过手机APP远程启动发动机： * 挡位不在驻车挡（P）位置。
* 冷却液液位较低。
* 燃油油位较低。
* 车内有遥控钥匙。
* 网络信号丢失。
...
EPB AUTO功能开启后，如果您在车辆处于静止状态时将车辆熄火，车辆将自动启用EPB。
...
- answer_non_empty: True
- must_include_term_coverage: 1.0000
- matched_must_include_terms: EPB AUTO; 静止; 熄火; 自动启用EPB
- missing_must_include_terms: N/A
- forbidden_term_hits: N/A
- evidence_structure_hit: False
- expected_section_hit: True
...
在洗车或牵引车辆等特殊情况下，您可以通过以下两种方式让车辆熄火后EPB保持释放状态：

**方式一：**

1. 在中央显示屏上关闭EPB AUTO功能。
2. 踩住制动踏板，将变速器切换至N挡。
3. 按下EPB开关，将EPB切换至释放状态。
4. 长按START/STOP按钮使车辆熄火。

**方式二：**

1. 不踩制动踏板，长按START/STOP按钮7秒，待车辆完成自检。
2. 踩住制动踏板，将变速器切换至N挡。
3. 按下EPB开关，将EPB切换至释放状态。
4. 长按START/STOP按钮使车辆下电。

**请注意：** 在EPB处于释放状态时，务必注意车辆周边环境，防止溜车危险。牵引车辆时，在车辆牵引至平板拖车前，需要挂入空挡（N）并解除EPB功能。车辆被牵引至平板拖车后，请将变速器挂入驻车挡（P）并启用电子驻车制动（EPB），以确保车辆驻车安全性。

**Final answer:**

在洗车或牵引车辆等特殊情况下，您可以通过以下两种方式让车辆熄火后EPB保持释放状态： **方式一：** 1. 在中央显示屏上关闭EPB AUTO功能。
2. 踩住制动踏板，将变速器切换至N挡。
3. 按下EPB开关，将EPB切换至释放状态。
4. 长按START/STOP按钮使车辆熄火。 **方式二：** 1. 不踩制动踏板，长按START/STOP按钮7秒，待车辆完成自检。
2. 踩住制动踏板，将变速器切换至N挡。
3. 按下EPB开关，将EPB切换至释放状态。
4. 长按START/STOP按钮使车辆下电。 **请注意：** 在EPB处于释放状态时，务必注意车辆周边环境，防止溜车危险。牵引车辆时，在车辆牵引至平板拖车前，需要挂入空挡（N）并解除EPB功能。车辆被牵引至平板拖车后，请将变速器挂入驻车挡（P）并启用电子驻车制动（EPB），以确保车辆驻车安全性。
...
如果出现红色常亮指示灯，请拔出充电枪，锁止车辆，等待车辆休眠后再进行充电操作。若再次尝试红色指示灯还是持续点亮，请联系领克中心寻求帮助。

**Final answer:**

充电接口 LED 指示灯根据不同的充电状态显示不同的颜色： * 蓝色常亮（2 分钟后熄灭）：预约充电。
* 蓝色闪烁：对外放电。
* 绿色闪烁：充电中。
* 绿色常亮：充电完成。
* 绿-绿-红依次闪烁：充电中电子锁故障。
* 红色常亮：充电故障。
* 橙色常亮：充电预加热中。
* 橙-橙-红依次闪烁：充电预加热中电子锁故障。 如果出现红色常亮指示灯，请拔出充电枪，锁止车辆，等待车辆休眠后再进行充电操作。若再次尝试红色指示灯还是持续点亮，请联系领克中心寻求帮助。
...
我没有在手册中找到可靠依据。手册中没有提及通过语音命令校准制动系统的功能。如果仪表显示制动系统故障指示灯，请立刻在安全区域停车并联系 Lynk & Co 领克中心。
